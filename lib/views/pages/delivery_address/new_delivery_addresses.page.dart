...
class NewDeliveryAddressesPage extends StatelessWidget {
  const NewDeliveryAddressesPage({Key? key, this.initialDeliveryAddress})
    : super(key: key);

  final DeliveryAddress? initialDeliveryAddress;

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<NewDeliveryAddressesViewModel>.reactive(
      viewModelBuilder:
          () => NewDeliveryAddressesViewModel(context, initialDeliveryAddress),
